...
gcloud run deploy "$SERVICE" \
  ...
  --timeout 3600 \
  --no-cpu-throttling \
  --set-env-vars NODE_ENV=production,GOOGLE_FACTORY_IMPERSONATE_WORKSPACE=false,GOOGLE_FACTORY_PREFER_OAUTH_WRITES=true,AUTHORLOOM_WORKER_POLL_MS=5000,GOOGLE_OAUTH_TOKEN_PATH=/secrets/google-oauth-token.json \
